...
public class Message {
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("id", id).add("type", type)
				.add("createdtime", createdTime).add("from", from)
				.add("to", to).add("additional",additionalInfo).toString();
	}
